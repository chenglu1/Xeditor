...
var ConfigurableTiptapEditor = function (_a) {
    var _b = _a.value, value = _b === void 0 ? '' : _b, _c = _a.contentType, contentType = _c === void 0 ? 'markdown' : _c, _d = _a.placeholder, placeholder = _d === void 0 ? '开始输入...' : _d, _e = _a.readOnly, readOnly = _e === void 0 ? false : _e, _f = _a.showToolbar, showToolbar = _f === void 0 ? true : _f, toolbarButtons = _a.toolbarButtons, _g = _a.dualView, dualView = _g === void 0 ? false : _g, _h = _a.className, className = _h === void 0 ? '' : _h, _j = _a.minHeight, minHeight = _j === void 0 ? '300px' : _j, _k = _a.compact, compact = _k === void 0 ? false : _k, uploadHandler = _a.uploadHandler, uploadUrl = _a.uploadUrl, _l = _a.maxFileSize, maxFileSize = _l === void 0 ? tiptap_utils_1.MAX_FILE_SIZE : _l, maxLength = _a.maxLength, onChange = _a.onChange;
    var isMobile = use_mobile_1.useIsMobile();
    var _m = react_2.useState('richtext'), activeMode = _m[0], setActiveMode = _m[1];
    // 创建上传处理函数
    var imageUploadHandler = uploadHandler ||
        upload_utils_1.createUploadHandler({
            uploadUrl: uploadUrl,
            extraFormData: maxFileSize ? {} : undefined
        });
    // 判断是否显示某个按钮
    var shouldShowButton = function (button) {
        if (!toolbarButtons)
            return true;
    ...
    var toolbarConfig = {
        ...
        showAlign: shouldShowButton('alignLeft') ||
    ...
    var editor = react_1.useEditor({
        ...
        editorProps: {
            ...
            handleTextInput: function (view, from, to, text) {
                ...
                var newLength = currentCount - selectedLength + text.length;
                // 如果新长度超过限制，阻止输入
        ...
        onUpdate: function (_a) {
            ...
            if (onChange) {
                try {
                    var content = contentType === 'markdown'
                        ? editor.getMarkdown()
                        : editor.getHTML();
    ...
    // 双视图模式的渲染
    if (dualView) {
        return (react_2["default"].createElement(DualViewEditor_1.DualViewEditor, { editor: editor, activeMode: activeMode, placeholder: placeholder, readOnly: readOnly, contentType: contentType, toolbarConfig: toolbarConfig, isMobile: isMobile, onModeChange: onModeChange }));
    }
    // 单视图模式的渲染
    return (react_2["default"].createElement(SingleViewEditor_1.SingleViewEditor, { editor: editor, placeholder: placeholder, minHeight: minHeight, compact: compact, showToolbar: showToolbar, toolbarConfig: toolbarConfig, isMobile: isMobile, className: className }));
};
